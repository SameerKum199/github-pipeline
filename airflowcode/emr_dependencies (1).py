...
def create_cluster(region_name, cluster_name='Sameer_Cluster_' + str(datetime.now()), release_label='emr-5.34.0',master_instance_type='m5.xlarge', num_core_nodes=2, core_node_instance_type='m5.xlarge'):
        ...
        BootstrapActions= [
                {
                    ...
                    'ScriptBootstrapAction': {
                            'Path': 's3://sameerlandingzone/Dependencies/install_deltacore.sh',
                        }
                }
            ],
